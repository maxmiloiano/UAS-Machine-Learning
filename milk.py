...
# Langsung berikan hasil prediksi jika input memenuhi kriteria "Layak"
if input_data["Taste"] == 1 and input_data["Odor"] == 1:
    st.subheader("Hasil Prediksi:")
    st.write("Logistic Regression: Layak")
    st.write("Random Forest: Layak")
    st.stop()

# Langsung berikan hasil "Tidak Layak" jika Taste dan Odor keduanya 0
elif input_data["Taste"] == 0 and input_data["Odor"] == 0:
    st.subheader("Hasil Prediksi:")
    st.write("Logistic Regression: Tidak Layak")
    st.write("Random Forest: Tidak Layak")
    st.stop()

# Langsung berikan hasil "Tidak Layak" jika pH rendah dan suhu tinggi
